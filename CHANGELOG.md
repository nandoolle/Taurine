...
- Com o bloqueio ativo, o componente é avisado pelo sistema assim que o app é apagado ou movido e restaura o repouso na hora — antes isso só acontecia no boot seguinte. Se o app for apagado com o Mac desligado, restaure o repouso com `sudo pmset -a disablesleep 0`.

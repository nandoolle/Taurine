...
/usr/libexec/PlistBuddy -c 'Add :CFBundleShortVersionString string 0.5.1' "$app/Contents/Info.plist"
...
cp src/Taurine/Resources/fizz-out.wav "$app/Contents/Resources/"

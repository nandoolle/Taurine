...
/usr/bin/codesign --force --sign - "$app/Contents/Library/LaunchDaemons/dev.taurine.helper"
...
/usr/libexec/PlistBuddy -c 'Add :CFBundleVersion string 6' "$app/Contents/Info.plist"
